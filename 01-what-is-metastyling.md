...
- [DMES Vectors](./02-dmes-vectors.md) — Four entangled vectors *(to be created)*
- [Faces as Attractors](./03-faces-attractors.md) — Stable identity modes *(to be created)*
- [Levels of Awareness](./04-levels-of-awareness.md) — Observational depth *(to be created)*
- [Modulation Mechanisms](./05-modulation-mechanisms.md) — How change happens *(to be created)*

**Mathematical foundation**:
- [Master Equation](../formulas/master-equation.md) — Complete formalism *(to be created)*
- [Cost Function](../formulas/cost-function.md) — Transition economics *(to be created)*
- [Forecasting](../formulas/forecasting.md) — Modeling probable futures *(to be created)*

**Applications**:
- [Personal Navigation](../applications/personal-navigation.md) — Identity work protocols *(to be created)*
- [Organizational Development](../applications/organizational-development.md) — Team dynamics *(to be created)*

**Case Studies**:
- [Kendall Roy Analysis](../case-studies/kendall-roy-analysis.md) — Leadership collapse patterns *(to be created)*
- [Oprah Winfrey Transition](../case-studies/oprah-winfrey-transition.md) — LoA 2→3 shift *(to be created)*

**Reference**:
- [Glossary](../GLOSSARY.md) — All terms defined *(to be created)*
